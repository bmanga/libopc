...
void writef(opcContainerOutputStream* stream, const char *s, ...) {
    ...
    opcContainerWriteOutputStream(stream, (const uint8_t *)buf, len);
    va_end(ap);
}

void writes(opcContainerOutputStream* stream, const char *s) {
    int const len=strlen(s);
    opcContainerWriteOutputStream(stream, (const uint8_t *)s, len);
}
...
static opcPart create_docProps_app_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("docProps/app.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.extended-properties+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("docProps/app.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.extended-properties+xml"), 0))) {
         //adding content
...
static opcPart create_docProps_core_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("docProps/core.xml"), BAD_CAST("application/vnd.openxmlformats-package.core-properties+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("docProps/core.xml"), BAD_CAST("application/vnd.openxmlformats-package.core-properties+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_docProps_thumbnail_jpeg(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("docProps/thumbnail.jpeg"), NULL, 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("docProps/thumbnail.jpeg"), NULL, 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
              static uint8_t data[]={
              ...
              opcContainerWriteOutputStream(out, (const uint8_t*)data, sizeof(data));
              opcContainerCloseOutputStream(out);
          }
          // adding relations
     }
...
static opcPart create_ppt_presProps_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/presProps.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.presProps+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/presProps.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.presProps+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_presentation_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/presentation.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.presentation.main+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/presentation.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.presentation.main+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
          ...
          // adding relations
          opcRelationAdd(c, ret, BAD_CAST("rId1"), create_ppt_slideMasters_slideMaster1_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideMaster"));
          opcRelationAdd(c, ret, BAD_CAST("rId2"), create_ppt_slides_slide1_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide"));
          opcRelationAdd(c, ret, BAD_CAST("rId3"), create_ppt_presProps_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/presProps"));
          opcRelationAdd(c, ret, BAD_CAST("rId4"), create_ppt_viewProps_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/viewProps"));
          opcRelationAdd(c, ret, BAD_CAST("rId5"), create_ppt_theme_theme1_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme"));
          opcRelationAdd(c, ret, BAD_CAST("rId6"), create_ppt_tableStyles_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/tableStyles"));
     }
     return ret;
}

static opcPart create_ppt_slideLayouts_slideLayout1_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout10_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout10.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout10.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout11_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout11.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout11.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout2_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout2.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout2.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout3_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout3.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout3.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout4_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout4.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout4.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout5_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout5.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout5.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout6_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout6.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout6.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout7_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout7.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout7.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout8_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout8.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout8.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideLayouts_slideLayout9_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideLayouts/slideLayout9.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideLayouts/slideLayout9.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_slideMasters_slideMaster1_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slideMasters/slideMaster1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slideMasters/slideMaster1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
          ...
          // adding relations
          opcRelationAdd(c, ret, BAD_CAST("rId1"), create_ppt_slideLayouts_slideLayout1_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId2"), create_ppt_slideLayouts_slideLayout2_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId3"), create_ppt_slideLayouts_slideLayout3_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId4"), create_ppt_slideLayouts_slideLayout4_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId5"), create_ppt_slideLayouts_slideLayout5_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId6"), create_ppt_slideLayouts_slideLayout6_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId7"), create_ppt_slideLayouts_slideLayout7_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId8"), create_ppt_slideLayouts_slideLayout8_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId9"), create_ppt_slideLayouts_slideLayout9_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId10"), create_ppt_slideLayouts_slideLayout10_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId11"), create_ppt_slideLayouts_slideLayout11_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout"));
          opcRelationAdd(c, ret, BAD_CAST("rId12"), create_ppt_theme_theme1_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme"));
     }
     return ret;
}

static opcPart create_ppt_slides_slide1_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/slides/slide1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slide+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/slides/slide1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.slide+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_tableStyles_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/tableStyles.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.tableStyles+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/tableStyles.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.tableStyles+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_theme_theme1_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/theme/theme1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.theme+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/theme/theme1.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.theme+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
static opcPart create_ppt_viewProps_xml(opcContainer *c) {
     opcPart ret=opcPartFind(c, BAD_CAST("ppt/viewProps.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.viewProps+xml"), 0);
     if (OPC_PART_INVALID==ret && OPC_PART_INVALID!=(ret=opcPartCreate(c, BAD_CAST("ppt/viewProps.xml"), BAD_CAST("application/vnd.openxmlformats-officedocument.presentationml.viewProps+xml"), 0))) {
         //adding content
          opcContainerOutputStream *out=opcContainerCreateOutputStream(c, ret, OPC_COMPRESSIONOPTION_NORMAL);
          if (NULL!=out) {
...
void generate(opcContainer *c, FILE *out) {
     ...
     opcExtensionRegister(c, BAD_CAST("jpeg"), BAD_CAST("image/jpeg"));
     opcExtensionRegister(c, BAD_CAST("rels"), BAD_CAST("application/vnd.openxmlformats-package.relationships+xml"));
     opcExtensionRegister(c, BAD_CAST("xml"), BAD_CAST("application/xml"));
     // adding root relations
     opcRelationAdd(c, OPC_PART_INVALID, BAD_CAST("rId1"), create_ppt_presentation_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument"));
     opcRelationAdd(c, OPC_PART_INVALID, BAD_CAST("rId2"), create_docProps_thumbnail_jpeg(c), BAD_CAST("http://schemas.openxmlformats.org/package/2006/relationships/metadata/thumbnail"));
     opcRelationAdd(c, OPC_PART_INVALID, BAD_CAST("rId3"), create_docProps_core_xml(c), BAD_CAST("http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties"));
     opcRelationAdd(c, OPC_PART_INVALID, BAD_CAST("rId4"), create_docProps_app_xml(c), BAD_CAST("http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties"));
...
int main( int argc, const char* argv[] ) {
    ...
    if (OPC_ERROR_NONE==opcInitLibrary() && 2==argc) {
         opcContainer *c=NULL;
         if (NULL!=(c=opcContainerOpen(BAD_CAST(argv[1]), OPC_OPEN_WRITE_ONLY, NULL, NULL))) {
              generate(c, stdout);
